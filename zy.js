...
//{ chat: "consultasgratisYan2", bot: "SkynetBlackRobot" },

{ chat: "noxbuscas", bot: "Noxbuscasbot" },
...
const apiId = `25466415`; //https://my.telegram.org/auth

const apiHash = `8bdbd3a963a4c95081f9f30fdc38fe9d`; //https://my.telegram.org/auth

const stringSession = new StringSession(``)
...
(async () => {
	...
	await telegram.start({
		...
		phoneNumber: "5511981989509", // SEU NUMERO DE TELEFONE AQUI DA CONTA DO TELEGRAM QUE DESEJA USAR!
